      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 sm:gap-16 items-start">
          ...
          >
            ...
            <h3 className="text-2xl sm:text-3xl md:text-4xl font-display font-bold text-slate-900 mb-4 sm:mb-6" data-testid="text-contact-title">
            ...
            <div className="space-y-6 sm:space-y-8">
              <div className="flex items-start">
                <div className="bg-white p-3 rounded-xl shadow-sm border border-slate-100 mr-4 flex-shrink-0">
                  <Mail className="w-5 h-5 sm:w-6 sm:h-6 text-primary" />
                </div>
                <div>
                  <h4 className="font-bold text-slate-900">Email Us</h4>
                  <a href="mailto:wf-t@gmx.de" className="text-slate-600 break-all" data-testid="link-contact-email">wf-t@gmx.de</a>
                </div>
              </div>
          ...
          <motion.div
            ...
            className="bg-white p-4 sm:p-8 md:p-10 rounded-2xl sm:rounded-3xl shadow-xl shadow-slate-200/50 border border-slate-100 relative"
          >
            ...
            <h4 className="text-xl sm:text-2xl font-display font-bold text-slate-900 mb-6 sm:mb-8">Request a Free Quote</h4>
            <ContactForm />
          </motion.div>
